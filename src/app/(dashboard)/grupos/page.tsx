...
import { Copy, ExternalLink, Check, UserCircle, Pencil, Trash2, MessageCircle, Send } from "lucide-react"
...
export default function GroupsPage() {
  ...
  const filteredGroups = useMemo(() => {
    if (selectedProfileId === "all") return groups
    return groups.filter((g) => g.profileId === selectedProfileId)
  }, [groups, selectedProfileId])
            ...
            <CardContent className="p-0 mt-2">
              <p className="text-muted-foreground">
                {selectedProfileId === "all"
                  ...
                  : "Não há grupos correspondentes a este perfil."}
              </p>
            </CardContent>
          </Card>
        ) : (
                    ...
                    <TableRow key={group.id}>
                      ...
                      <TableCell>
                        <Badge variant="outline" className="font-normal">
                          {group.profile?.name || "Perfil desconhecido"}
                        </Badge>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell>
                        <div className="space-y-2">
                          <div className="text-sm">{group.memberCount} / {memberLimit}</div>
